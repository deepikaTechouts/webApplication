...
tabledividing.leftTable.button-color {
...
<body>
	...
	<br>
	<br>
	<form action="updateByPhoneNo" method="post">

		<c:forEach var="p" items="${res}" varStatus="status">
			...
			<div class="rightTable">
				<center>
					<table>
						...
						<tr>
							<td>Aadhar No:</td>
							<td><input type="number" name="" value="${p.aadharNo }"
								readonly="readonly"></td>
						</tr>
						<tr>
							<td>First Name:</td>
							<td><input type="text" name="first" value="${p.fname }"></td>
						</tr>
						<tr>
							<td>Last Name:</td>
							<td><input type="text" name="last" value="${p.lname }"></td>
						</tr>
						<tr>
							<td>Phone No:</td>
							<td><input type="number" name="phone" value="${p.phoneNo }"></td>
						</tr>
						<tr>
							<td>DOB:</td>
							<td><input type="number" name="dob" value="${p.dob }"></td>
						</tr>
						<tr>
							<td>Email-ID:</td>
						...
						<tr>
							<td>Gender:</td>
							<td><input type="text" name="gender" value="${p.gender}"></td>
						</tr>
						<tr>
							<td>Address:</td>
...
<%-- <center>update by AadharNo or PhoneNo<table>
	<tr>
		<td>AadharNo:</td>
